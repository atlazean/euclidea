\ProvidesFile{tikzlibraryeuclidea.code.tex}[2024/01/11 v1.3.1 A tikz library for plane geometry]
...
% Syntax of parabola: x^2=2py
%   \parabola [options] (p); 
% wherein, p is the semi-latus rectum.
% x = 2pt, y = 2pt^2
\newcommand\parabola{} % just for safety
\def\parabola[#1]#2(#3){
  \path[smooth,domain=-2:2,#1,variable=\euclidea@var]
    plot({2*(#3)*\euclidea@var},{2*(#3)*\euclidea@var*\euclidea@var})
}
