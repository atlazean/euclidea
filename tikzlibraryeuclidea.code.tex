...
\tikzset{
  ...
  conic/define/.code args = {#1,#2,#3,#4,#5,#6}{
    ...
    \typeout{[\cs@Q{1,1}, \cs@Q{1,2}, \cs@Q{1,3}]}
    \typeout{[\cs@Q{2,1}, \cs@Q{2,2}, \cs@Q{2,3}]}
    \typeout{[\cs@Q{3,1}, \cs@Q{3,2}, \cs@Q{3,3}]}
    \typeout{the matrix of the quadratic equation in standard form:}
    \typeout{[\cs@R{1,1}, \cs@R{1,2}, \cs@R{1,3}]}
    \typeout{[\cs@R{2,1}, \cs@R{2,2}, \cs@R{2,3}]}
    \typeout{[\cs@R{3,1}, \cs@R{3,2}, \cs@R{3,3}]}
