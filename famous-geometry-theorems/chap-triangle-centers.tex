...
\begin{tikzpicture}[scale=.5]
  ...
  \foreach \point in {I,JA,JB,JC}
    \fill (\point) [orange] circle (2pt);
  %\draw (\point) node[below] {$E$};
  \node[draw,orange] at (I) [circle through=($(B)!(I)!(C)$)]{};
